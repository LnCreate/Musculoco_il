...
parser.add_argument("--env-id", type=str, default="HumanoidMuscle.walk",
                    help="LocoMuJoCo env id (e.g., HumanoidMuscle.walk / HumanoidMuscle.run)")
...
dataset = core.evaluate(render=True, n_episodes=8, record=True)
