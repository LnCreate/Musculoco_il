...
PYTHONPATH=. uv run python experiments/eval/pol_runner_activation.py -f logs/09_gail_smooth_walk/1/agent_epoch_247_J_979.374208.msh --env-id HumanoidMuscle.walk --deterministic --hide-box-feet --black-floor --white-background --body-rgba "0.8 0.8 0.8 1.0" --episodes 5 --max-steps 5000 --dim-light --light-scale 0.45 --ambient-scale 0.45 --specular-scale 0.06